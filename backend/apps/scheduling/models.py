    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                ...
                name="ix_appt_tenant_start",
            ),
            models.Index(
                fields=["tenant", "professional", "start_at"],
                name="ix_appt_prof_start",
            ),
            models.Index(
                fields=["tenant", "client", "start_at"],
                name="ix_appt_client_start",
            ),
        ]
